...
import { Search, Shield, UserCheck, ShieldAlert, CheckCircle2, User } from 'lucide-react'
...
export default function TabelPengguna({ initialUsers, currentUserId }: TabelPenggunaProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative max-w-sm">
        ...
        <Input
          type="text"
          placeholder="Cari nama, unit kerja, atau role..."
          value={searchQuery}
              ...
              <TableRow>
                <TableCell colSpan={5} className="text-center py-12 text-slate-400 text-xs">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span>Tidak ada pengguna yang sesuai pencarian.</span>
                  </div>
                </TableCell>
              </TableRow>
            )}
